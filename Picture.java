...
public class Picture extends SimplePicture 
{
  ...
  {
    Picture flower1 = new Picture("H:\\GeorgeCheng\\Unit16-Picture-Lab\\src\\images\\flower1.jpg");
    Picture flower2 = new Picture("H:\\GeorgeCheng\\Unit16-Picture-Lab\\src\\images\\flower2.jpg");
    ...
    this.mirrorVertical();
    this.write("H:\\GeorgeCheng\\Unit16-Picture-Lab\\src\\images\\collage.jpg");
  }
		  	...
		  	for (int row = 0; row < this.getHeight(); row++)
	  	{
  			...
  			int distance = 0;
  		  		...
  		  		if (!(messagePixel.colorDistance(Color.BLACK) < 50) && msgCol < this.getHeight())
		  			{
		  				while(!(messagePixels[msgRow][msgCol].colorDistance(Color.BLACK)<50)){
		  					distance++;
		  					msgCol++;
  ...
  public Picture decode()
  {
	  ...
	  for (int row = 0; row < height; row++)
	  {
		  ...
		  for (int col = 0; col < width; col++)
		  {
			  ...
			  for(int a = 0; a < currPixel.getAlpha(); a++) {
				  if(msgRow == this.getHeight()-1) {
						break;
			  }
				  if(msgCol == 480)
				  ...
				  for(int b = 0; b < currPixel.getAlpha(); b++) {
